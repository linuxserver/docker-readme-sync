...
Instead edit the [readme-vars.yml](https://github.com/linuxserver/docker-readme-sync/edit/master/readme-vars.yml).
...
docker build \
  --no-cache \
  --pull \
  -t linuxserver/readme-sync:latest .
```
